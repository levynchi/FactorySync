...
class OptitexAnalyzerGUI:
    def __init__(self, root):
        ...
        self.products_file = ""
        self.output_df = None
        self.drawings_data = []  # רשימת כל הציורים המקומית
    ...
    def load_drawings_data(self):
        """טעינת נתוני ציורים מקומיים מקובץ JSON"""
        drawings_file = "drawings_data.json"
        try:
    ...
    def save_drawings_data(self):
        """שמירת נתוני ציורים מקומיים לקובץ JSON"""
        try:
            with open("drawings_data.json", 'w', encoding='utf-8') as f:
